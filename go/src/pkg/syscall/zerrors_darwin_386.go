...
<head>
  ...
  <title>Source file /src/pkg/syscall/zerrors_darwin_386.go</title>
...
<div id="content">
  <h1 id="generatedHeader">Source file /src/pkg/syscall/zerrors_darwin_386.go</h1>
...
<a id="L11"></a>const (
    ...
    <a id="L514"></a>WORDSIZE                  = 0x20;
    <a id="L515"></a>WSTOPPED                  = 0x7f;
    <a id="L516"></a>WUNTRACED                 = 0x2;
<a id="L517"></a>)

<a id="L519"></a><span class="comment">// Types</span>


<a id="L522"></a><span class="comment">// Error table</span>
<a id="L523"></a>var errors = [...]string{
    <a id="L524"></a>95: &#34;EMULTIHOP (Reserved)&#34;,
    <a id="L525"></a>47: &#34;address family not supported by protocol family&#34;,
    <a id="L526"></a>13: &#34;permission denied&#34;,
    <a id="L527"></a>39: &#34;destination address required&#34;,
    <a id="L528"></a>92: &#34;illegal byte sequence&#34;,
    <a id="L529"></a>29: &#34;illegal seek&#34;,
    <a id="L530"></a>31: &#34;too many links&#34;,
    <a id="L531"></a>74: &#34;RPC prog. not avail&#34;,
    <a id="L532"></a>25: &#34;inappropriate ioctl for device&#34;,
    <a id="L533"></a>9: &#34;bad file descriptor&#34;,
    <a id="L534"></a>34: &#34;result too large&#34;,
    <a id="L535"></a>89: &#34;operation canceled&#34;,
    <a id="L536"></a>26: &#34;text file busy&#34;,
    <a id="L537"></a>12: &#34;cannot allocate memory&#34;,
    <a id="L538"></a>36: &#34;operation now in progress&#34;,
    <a id="L539"></a>66: &#34;directory not empty&#34;,
    <a id="L540"></a>15: &#34;block device required&#34;,
    <a id="L541"></a>41: &#34;protocol wrong type for socket&#34;,
    <a id="L542"></a>91: &#34;no message of desired type&#34;,
    <a id="L543"></a>73: &#34;RPC version wrong&#34;,
    <a id="L544"></a>20: &#34;not a directory&#34;,
    <a id="L545"></a>37: &#34;operation already in progress&#34;,
    <a id="L546"></a>60: &#34;operation timed out&#34;,
    <a id="L547"></a>81: &#34;need authenticator&#34;,
    <a id="L548"></a>96: &#34;no message available on STREAM&#34;,
    <a id="L549"></a>4: &#34;interrupted system call&#34;,
    <a id="L550"></a>97: &#34;ENOLINK (Reserved)&#34;,
    <a id="L551"></a>1: &#34;operation not permitted&#34;,
    <a id="L552"></a>50: &#34;network is down&#34;,
    <a id="L553"></a>70: &#34;stale NFS file handle&#34;,
    <a id="L554"></a>38: &#34;socket operation on non-socket&#34;,
    <a id="L555"></a>98: &#34;no STREAM resources&#34;,
    <a id="L556"></a>80: &#34;authentication error&#34;,
    <a id="L557"></a>10: &#34;no child processes&#34;,
    <a id="L558"></a>32: &#34;broken pipe&#34;,
    <a id="L559"></a>93: &#34;attribute not found&#34;,
    <a id="L560"></a>94: &#34;bad message&#34;,
    <a id="L561"></a>71: &#34;too many levels of remote in path&#34;,
    <a id="L562"></a>59: &#34;too many references: can&#39;t splice&#34;,
    <a id="L563"></a>46: &#34;protocol family not supported&#34;,
    <a id="L564"></a>76: &#34;bad procedure for program&#34;,
    <a id="L565"></a>48: &#34;address already in use&#34;,
    <a id="L566"></a>52: &#34;network dropped connection on reset&#34;,
    <a id="L567"></a>21: &#34;is a directory&#34;,
    <a id="L568"></a>90: &#34;identifier removed&#34;,
    <a id="L569"></a>83: &#34;device error&#34;,
    <a id="L570"></a>22: &#34;invalid argument&#34;,
    <a id="L571"></a>58: &#34;can&#39;t send after socket shutdown&#34;,
    <a id="L572"></a>82: &#34;device power is off&#34;,
    <a id="L573"></a>84: &#34;value too large to be stored in data type&#34;,
    <a id="L574"></a>16: &#34;resource busy&#34;,
    <a id="L575"></a>67: &#34;too many processes&#34;,
    <a id="L576"></a>100: &#34;protocol error&#34;,
    <a id="L577"></a>19: &#34;operation not supported by device&#34;,
    <a id="L578"></a>30: &#34;read-only file system&#34;,
    <a id="L579"></a>7: &#34;argument list too long&#34;,
    <a id="L580"></a>11: &#34;resource deadlock avoided&#34;,
    <a id="L581"></a>54: &#34;connection reset by peer&#34;,
    <a id="L582"></a>88: &#34;malformed Mach-o file&#34;,
    <a id="L583"></a>6: &#34;device not configured&#34;,
    <a id="L584"></a>72: &#34;RPC struct is bad&#34;,
    <a id="L585"></a>63: &#34;file name too long&#34;,
    <a id="L586"></a>103: &#34;policy not found&#34;,
    <a id="L587"></a>44: &#34;socket type not supported&#34;,
    <a id="L588"></a>49: &#34;can&#39;t assign requested address&#34;,
    <a id="L589"></a>101: &#34;STREAM ioctl timeout&#34;,
    <a id="L590"></a>43: &#34;protocol not supported&#34;,
    <a id="L591"></a>5: &#34;input/output error&#34;,
    <a id="L592"></a>51: &#34;network is unreachable&#34;,
    <a id="L593"></a>18: &#34;cross-device link&#34;,
    <a id="L594"></a>69: &#34;disc quota exceeded&#34;,
    <a id="L595"></a>28: &#34;no space left on device&#34;,
    <a id="L596"></a>8: &#34;exec format error&#34;,
    <a id="L597"></a>40: &#34;message too long&#34;,
    <a id="L598"></a>79: &#34;inappropriate file type or format&#34;,
    <a id="L599"></a>33: &#34;numerical argument out of domain&#34;,
    <a id="L600"></a>99: &#34;not a STREAM&#34;,
    <a id="L601"></a>27: &#34;file too large&#34;,
    <a id="L602"></a>3: &#34;no such process&#34;,
    <a id="L603"></a>64: &#34;host is down&#34;,
    <a id="L604"></a>77: &#34;no locks available&#34;,
    <a id="L605"></a>23: &#34;too many open files in system&#34;,
    <a id="L606"></a>78: &#34;function not implemented&#34;,
    <a id="L607"></a>86: &#34;bad CPU type in executable&#34;,
    <a id="L608"></a>57: &#34;socket is not connected&#34;,
    <a id="L609"></a>45: &#34;operation not supported&#34;,
    <a id="L610"></a>53: &#34;software caused connection abort&#34;,
    <a id="L611"></a>56: &#34;socket is already connected&#34;,
    <a id="L612"></a>87: &#34;shared library version mismatch&#34;,
    <a id="L613"></a>68: &#34;too many users&#34;,
    <a id="L614"></a>42: &#34;protocol not available&#34;,
    <a id="L615"></a>24: &#34;too many open files&#34;,
    <a id="L616"></a>62: &#34;too many levels of symbolic links&#34;,
    <a id="L617"></a>55: &#34;no buffer space available&#34;,
    <a id="L618"></a>14: &#34;bad address&#34;,
    <a id="L619"></a>35: &#34;resource temporarily unavailable&#34;,
    <a id="L620"></a>85: &#34;bad executable (or shared library)&#34;,
    <a id="L621"></a>61: &#34;connection refused&#34;,
    <a id="L622"></a>17: &#34;file exists&#34;,
    <a id="L623"></a>75: &#34;program version wrong&#34;,
    <a id="L624"></a>2: &#34;no such file or directory&#34;,
    <a id="L625"></a>65: &#34;no route to host&#34;,
    <a id="L626"></a>102: &#34;operation not supported on socket&#34;,
<a id="L627"></a>}
</pre>
