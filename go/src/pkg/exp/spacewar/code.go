...
<head>
  ...
  <title>Source file /src/pkg/exp/spacewar/code.go</title>
...
<div id="content">
  <h1 id="generatedHeader">Source file /src/pkg/exp/spacewar/code.go</h1>
  ...
  <pre>
<a id="L1"></a><span class="comment">// This file contains the assembly language and machine code for</span>
<a id="L2"></a><span class="comment">// Spacewar!, the original PDP-1 video game.  It is downloaded from</span>
<a id="L3"></a><span class="comment">// http://spacewar.oversigma.com/sources/sources.zip which has</span>
<a id="L4"></a><span class="comment">// the following notice at http://spacewar.oversigma.com/:</span>
<a id="L5"></a><span class="comment">//</span>
<a id="L6"></a><span class="comment">//	Spacewar! was conceived in 1961 by Martin Graetz, Stephen Russell,</span>
<a id="L7"></a><span class="comment">//	and Wayne Wiitanen. It was first realized on the PDP-1 in 1962 by</span>
<a id="L8"></a><span class="comment">//	Stephen Russell, Peter Samson, Dan Edwards, and Martin Graetz,</span>
<a id="L9"></a><span class="comment">//	together with Alan Kotok, Steve Piner, and Robert A Saunders.</span>
<a id="L10"></a><span class="comment">//	Spacewar! is in the public domain, but this credit paragraph must</span>
<a id="L11"></a><span class="comment">//	accompany all distributed versions of the program.</span>
<a id="L12"></a><span class="comment">//</span>
<a id="L13"></a><span class="comment">//	This is the original version! Martin Graetz provided us with a</span>
<a id="L14"></a><span class="comment">//	printed version of the source. We typed in in again - it was about</span>
<a id="L15"></a><span class="comment">//	40 pages long - and re-assembled it with a PDP-1 assembler written</span>
<a id="L16"></a><span class="comment">//	in PERL. The resulting binary runs on a PDP-1 emulator written as</span>
<a id="L17"></a><span class="comment">//	a Java applet. The code is extremely faithful to the original. There</span>
<a id="L18"></a><span class="comment">//	are only two changes. 1)The spaceships have been made bigger and</span>
<a id="L19"></a><span class="comment">//	2) The overall timing has been special cased to deal with varying</span>
<a id="L20"></a><span class="comment">//	machine speeds.</span>
<a id="L21"></a><span class="comment">//</span>
<a id="L22"></a><span class="comment">//	The &#34;a&#34;, &#34;s&#34;, &#34;d&#34;, &#34;f&#34; keys control one of the spaceships. The &#34;k&#34;,</span>
<a id="L23"></a><span class="comment">//	&#34;l&#34;, &#34;;&#34;, &#34;&#39;&#34; keys control the other. The controls are spin one</span>
<a id="L24"></a><span class="comment">//	way, spin the other, thrust, and fire.</span>
<a id="L25"></a><span class="comment">//</span>
<a id="L26"></a><span class="comment">//	Barry Silverman</span>
<a id="L27"></a><span class="comment">//	Brian Silverman</span>
<a id="L28"></a><span class="comment">//	Vadim Gerasimov</span>
<a id="L29"></a><span class="comment">//</span>

<a id="L31"></a>package main

<a id="L33"></a>const spacewarCode = `
