...
<head>
  ...
  <title>Source file /doc/progs/helloworld3.go</title>
...
<div id="content">
  <h1 id="generatedHeader">Source file /doc/progs/helloworld3.go</h1>
...
<a id="L13"></a>func main() {
    <a id="L14"></a>hello := []byte{&#39;h&#39;, &#39;e&#39;, &#39;l&#39;, &#39;l&#39;, &#39;o&#39;, &#39;,&#39;, &#39; &#39;, &#39;w&#39;, &#39;o&#39;, &#39;r&#39;, &#39;l&#39;, &#39;d&#39;, &#39;\n&#39;};
    <a id="L15"></a>file.Stdout.Write(hello);
    <a id="L16"></a>file, err := file.Open(&#34;/does/not/exist&#34;, 0, 0);
    <a id="L17"></a>if file == nil {
        <a id="L18"></a>fmt.Printf(&#34;can&#39;t open file; err=%s\n&#34;, err.String());
        <a id="L19"></a>os.Exit(1);
    <a id="L20"></a>}
<a id="L21"></a>}
</pre>
