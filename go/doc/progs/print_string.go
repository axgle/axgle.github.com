...
<head>
  ...
  <title>Source file /doc/progs/print_string.go</title>
...
<div id="content">
  <h1 id="generatedHeader">Source file /doc/progs/print_string.go</h1>
...
<a id="L9"></a>type testType struct {
    a   int;
    b   string;
}

<a id="L11"></a>func (t *testType) String() string { <a id="L12"></a>return fmt.Sprint(t.a) + &#34; &#34; + t.b <a id="L13"></a>}

<a id="L15"></a>func main() {
    <a id="L16"></a>t := &amp;testType{77, &#34;Sunset Strip&#34;};
    <a id="L17"></a>fmt.Println(t);
<a id="L18"></a>}
</pre>
