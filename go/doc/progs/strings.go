...
<head>
  ...
  <title>Source file /doc/progs/strings.go</title>
...
<div id="content">
  <h1 id="generatedHeader">Source file /doc/progs/strings.go</h1>
...
<a id="L10"></a>func main() {
    <a id="L11"></a>s := &#34;hello&#34;;
    <a id="L12"></a>if s[1] != &#39;e&#39; {
        os.Exit(1)
    }
    <a id="L13"></a>s = &#34;good bye&#34;;
    <a id="L14"></a>var p *string = &amp;s;
    <a id="L15"></a>*p = &#34;ciao&#34;;
<a id="L16"></a>}
</pre>
