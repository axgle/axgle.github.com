...
<head>
  ...
  <title>Source file /doc/progs/server1.go</title>
...
<div id="content">
  <h1 id="generatedHeader">Source file /doc/progs/server1.go</h1>
...
<a id="L21"></a>func server(op binOp, service chan *request, quit chan bool) {
    <a id="L22"></a>for {
        <a id="L23"></a>select {
        <a id="L24"></a>case req := &lt;-service:
            <a id="L25"></a>go run(op, req) <span class="comment">// don&#39;t wait for it</span>
        <a id="L26"></a>case &lt;-quit:
            <a id="L27"></a>return
        <a id="L28"></a>}
    <a id="L29"></a>}
<a id="L30"></a>}

<a id="L32"></a>func startServer(op binOp) (service chan *request, quit chan bool) {
    <a id="L33"></a>service = make(chan *request);
    <a id="L34"></a>quit = make(chan bool);
    <a id="L35"></a>go server(op, service, quit);
    <a id="L36"></a>return service, quit;
<a id="L37"></a>}

<a id="L39"></a>func main() {
    <a id="L40"></a>adder, quit := startServer(func(a, b int) int { return a + b });
    <a id="L41"></a>const N = 100;
    <a id="L42"></a>var reqs [N]request;
    <a id="L43"></a>for i := 0; i &lt; N; i++ {
        <a id="L44"></a>req := &amp;reqs[i];
        <a id="L45"></a>req.a = i;
        <a id="L46"></a>req.b = i + N;
        <a id="L47"></a>req.replyc = make(chan int);
        <a id="L48"></a>adder &lt;- req;
    <a id="L49"></a>}
    <a id="L50"></a>for i := N - 1; i &gt;= 0; i-- { <span class="comment">// doesn&#39;t matter what order</span>
        <a id="L51"></a>if &lt;-reqs[i].replyc != N+2*i {
            <a id="L52"></a>fmt.Println(&#34;fail at&#34;, i)
        <a id="L53"></a>}
    <a id="L54"></a>}
    <a id="L55"></a>quit &lt;- true;
<a id="L56"></a>}
</pre>
