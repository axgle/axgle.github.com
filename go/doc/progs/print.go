...
<head>
  ...
  <title>Source file /doc/progs/print.go</title>
...
<div id="content">
  <h1 id="generatedHeader">Source file /doc/progs/print.go</h1>
...
<a id="L9"></a>func main() {
    <a id="L10"></a>var u64 uint64 = 1&lt;&lt;64 - 1;
    <a id="L11"></a>fmt.Printf(&#34;%d %d\n&#34;, u64, int64(u64));

    <a id="L13"></a><span class="comment">// harder stuff</span>
    <a id="L14"></a>type T struct {
        a   int;
        b   string;
    }
    <a id="L15"></a>t := T{77, &#34;Sunset Strip&#34;};
    <a id="L16"></a>a := []int{1, 2, 3, 4};
    <a id="L17"></a>fmt.Printf(&#34;%v %v %v\n&#34;, u64, t, a);
    <a id="L18"></a>fmt.Print(u64, &#34; &#34;, t, &#34; &#34;, a, &#34;\n&#34;);
    <a id="L19"></a>fmt.Println(u64, t, a);
<a id="L20"></a>}
</pre>
