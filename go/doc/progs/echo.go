...
<head>
  ...
  <title>Source file /doc/progs/echo.go</title>
...
<div id="content">
  <h1 id="generatedHeader">Source file /doc/progs/echo.go</h1>
...
<a id="L7"></a>import (
    <a id="L8"></a>&#34;os&#34;;
    <a id="L9"></a>&#34;flag&#34;; <span class="comment">// command line option parser</span>
<a id="L10"></a>)

<a id="L12"></a>var omitNewline = flag.Bool(&#34;n&#34;, false, &#34;don&#39;t print final newline&#34;)
...
<a id="L19"></a>func main() {
    <a id="L20"></a>flag.Parse(); <span class="comment">// Scans the arg list and sets up flags</span>
    <a id="L21"></a>var s string = &#34;&#34;;
    <a id="L22"></a>for i := 0; i &lt; flag.NArg(); i++ {
        <a id="L23"></a>if i &gt; 0 {
            <a id="L24"></a>s += Space
        <a id="L25"></a>}
        <a id="L26"></a>s += flag.Arg(i);
    <a id="L27"></a>}
    <a id="L28"></a>if !*omitNewline {
        <a id="L29"></a>s += Newline
    <a id="L30"></a>}
    <a id="L31"></a>os.Stdout.WriteString(s);
<a id="L32"></a>}
</pre>
