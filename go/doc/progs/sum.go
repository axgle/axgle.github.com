...
<head>
  ...
  <title>Source file /doc/progs/sum.go</title>
...
<div id="content">
  <h1 id="generatedHeader">Source file /doc/progs/sum.go</h1>
...
<a id="L9"></a>func sum(a []int) int { <span class="comment">// returns an int</span>
    <a id="L10"></a>s := 0;
    <a id="L11"></a>for i := 0; i &lt; len(a); i++ {
        <a id="L12"></a>s += a[i]
    <a id="L13"></a>}
    <a id="L14"></a>return s;
<a id="L15"></a>}
...
<a id="L18"></a>func main() {
    <a id="L19"></a>s := sum(&amp;[3]int{1, 2, 3}); <span class="comment">// a slice of the array is passed to sum</span>
    <a id="L20"></a>fmt.Print(s, &#34;\n&#34;);
<a id="L21"></a>}
</pre>
